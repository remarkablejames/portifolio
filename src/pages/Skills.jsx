    ...
    <>
      <div className="clouds overflow-hidden">
        <div className=" bg-black/100 h-full w-full ">
          <section
            id="about"
            class="bg-transparent flex items-center justify-around overflow-auto"
          >
            <div class="about_me flex  items-center     md:ml-24 md:flex-row space-x-6 pt-20 ">
              <div class="flex flex-col items-start justify-center">
                ...
                <div class="text-lg font-normal text-white max-w-2xl mt-6 text-justify ">
                  I'm a MERN stack developer, I can build a website from
                  scratch, giving it a unique design and functionality. I can
                  also build backend API's using Node.js and Express. Working in
                  a team is my character, learning new things faster is my
                  strength.
                </div>
              </div>
            </div>
