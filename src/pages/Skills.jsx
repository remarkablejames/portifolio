...
function Home() {
  return (
    <>
      <div className="clouds overflow-auto w-full bg-black/100">
        <div className=" bg-black/100 h-full w-full ">
          <AnimatedPage>
            ...
            >
              <div className="about_me flex  items-center justify-center w-full   md:flex-row space-x-6 pt-20 ">
                <div className="flex flex-col items-start justify-center ">
                  ...
                  <div className="text-lg font-normal text-white max-w-4xl mt-6 text-justify ">
